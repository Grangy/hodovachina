...
export default function CooperationFormats({ cityData }: CooperationFormatsProps = {}) {
  ...
  return (
    <section className="py-10 sm:py-12 md:py-16 lg:py-24 px-4 sm:px-6 lg:px-8 pb-20 sm:pb-24 md:pb-28 bg-purple-light dark:bg-gray-800 monochrome:bg-mono-light blue:bg-blue-light transition-colors overflow-hidden w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 md:gap-8">
          ...
          >
            ...
            <motion.button
              ...
              className="w-full bg-black dark:bg-purple-primary monochrome:bg-mono-primary monochrome:hover:bg-mono-dark hover:bg-gray-dark dark:hover:bg-purple-dark text-white px-5 sm:px-6 py-3 rounded-lg text-sm sm:text-base font-semibold transition-all hover:scale-105 active:scale-95 min-h-[44px]"
