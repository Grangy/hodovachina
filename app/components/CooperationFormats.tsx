...
export default function CooperationFormats({ cityData }: CooperationFormatsProps = {}) {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-purple-light dark:bg-gray-800 monochrome:bg-mono-light blue:bg-blue-light transition-colors">
